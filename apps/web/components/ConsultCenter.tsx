...
const TOOLS = [
  ...
  { id:"liuxiang", title:"六象合参", kind:"真实证据研究", status:"研究可用", needs:"多类授权记录；资料不足也可以如实起卷", description:"以命、业、愿、梦、缘、世六类证契并观；传统解释性映射仍未启用，也不会展示合成测试候选。", href:"/consult/liuxiang" },
  { id:"sushe", title:"宿世星图", kind:"原创专题研究", status:"研究可用", needs:"已授权的主体记录与结构标签", description:"排列一至三组确定性研究候选；姓名、年代、地点、身份与死因均明确标注为可能，不主张历史事实。", href:"/consult/sushe" },
  { id:"zhongyin", title:"中阴之门", kind:"原创专题研究", status:"研究可用", needs:"人生过渡记录；离世模式另需明确离世事实", description:"观察旧结构消散与新结构形成之间的过渡；不会预测在世主体的死亡时间、死法或寿命。", href:"/consult/zhongyin" },
  { id:"yuanqi", title:"缘契图", kind:"原创专题研究", status:"研究可用", needs:"关系事件、承诺与相应同意范围", description:"区分单方观察与双方合参，不输出命定伴侣、必然复合或不可改变的关系结论。", href:"/consult/yuanqi" },
