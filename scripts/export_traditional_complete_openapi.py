"""Export the owner-only complete traditional research API contract."""
import json,sys
from pathlib import Path
from fastapi import FastAPI
ROOT=Path(__file__).resolve().parents[1]; sys.path.insert(0,str(ROOT))
from apps.api.app.traditional_complete_routes import router
app=FastAPI(title="Sanji Traditional Algorithms Complete V1 API",version="1.0.0"); app.include_router(router)
