...
三际观是面向少数授权使用者的私人研究系统；三际枢是其确定性核心。当前阶段为
`1.0.0-rc.1` 工程候选，仓库保持 Private，所有传统与三际原创推演规则仍是研究态。
...
以下事项必须等待产品负责人书面确认：生产规则激活、仓库 Public、Tag/Release、正式
许可证、规则/知识授权、restricted/sealed 内容、生产 KMS、数据地区、备份保留和删除
SLA。Codex、LLM 或无资质审核者不得代替传统/传承审校人。
